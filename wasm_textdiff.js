...
* @returns {DiffResult}
*/
export function diff(alg, l, r) {
    const ptr0 = passStringToWasm0(alg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(l, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
export class DiffResult {
    ...
    free() {
        ...
        wasm.__wbg_diffresult_free(ptr);
    }
    /**
    * @returns {string}
    */
    get_table() {
        try {
            ...
            wasm.diffresult_get_table(retptr, this.ptr);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('wasm_textdiff_bg.wasm', import.meta.url);
    }
    const imports = getImports();
